package net.archasmiel.thaumcraft.menu;
...
public class ArcaneWorkbenchMenu extends RecipeBookMenu<CraftingContainer> {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(this.access, pPlayer, Blocks.ARCANE_WORKBENCH.get());
    }
